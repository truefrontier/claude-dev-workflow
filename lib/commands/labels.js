...
const WORKFLOW_LABELS = [
  ...
  { name: 'needs:specify', description: 'AI is creating software specifications using GitHub spec-kit methodology', color: '0052cc' },
  { name: 'needs:specify-revision', description: 'AI is revising software specifications based on feedback', color: '0052cc' },
  { name: 'needs:plan', description: 'AI is creating technical implementation plan', color: '5319e7' },
  { name: 'needs:plan-revision', description: 'AI is revising technical plan based on feedback', color: '5319e7' },
  { name: 'needs:tasks', description: 'AI is breaking down plan into systematic development tasks', color: 'f57c00' },
  { name: 'needs:tasks-revision', description: 'AI is revising task breakdown based on feedback', color: 'f57c00' },
  { name: 'needs:develop', description: 'AI is implementing code following approved specs, plan, and tasks', color: '2e7d32' },
  ...
  { name: 'review:specify', description: 'Software specifications ready for human review', color: '81c784' },
  { name: 'review:plan', description: 'Technical implementation plan ready for human review', color: 'ba68c8' },
  { name: 'review:tasks', description: 'Task breakdown ready for human review', color: 'ffb74d' },
  { name: 'review:develop', description: 'Implementation ready for human review', color: 'a5d6a7' },

  // error:* labels (needs human intervention)
  { name: 'error:specify', description: 'Specification stage encountered an error', color: 'd32f2f' },
  { name: 'error:plan', description: 'Planning stage encountered an error', color: 'd32f2f' },
  { name: 'error:tasks', description: 'Task breakdown stage encountered an error', color: 'd32f2f' },
