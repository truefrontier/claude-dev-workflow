...
const WORKFLOW_LABELS = [
  ...
  { name: 'needs:tasks', description: 'AI is breaking down plan into systematic development tasks', color: 'F9F8F3' },
  { name: 'needs:tasks-revision', description: 'AI is revising task breakdown based on feedback', color: 'F9F8F3' },
  { name: 'needs:develop', description: 'AI is implementing code following approved specs, plan, and tasks', color: 'F9F8F3' },
  ...
  { name: 'review:tasks', description: 'Task breakdown ready for human review', color: '1e3a8a' },
  ...
  { name: 'error:tasks', description: 'Task breakdown stage encountered an error', color: '991b1b' },
