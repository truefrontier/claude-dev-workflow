...
function helpCommand() {
  ...
  console.log(chalk.cyan('npx claude-dev-workflow init') + ' - Initialize workflow in current repo');
  console.log(chalk.cyan('npx claude-dev-workflow validate') + ' - Check current setup');
  console.log(chalk.cyan('npx claude-dev-workflow labels --setup') + ' - Create required labels\n');
  ...
  console.log('1. Run: ' + chalk.cyan('npx claude-dev-workflow init'));
